        ...
        <Container maxWidth="sm" justifyContent="center" alignItems="center">
          ...
          <Box mt={7}>
            <Typography className={classes.regularTypography}>
              FormMotion is an infinite jumping game that allows you to draw
              your own avatar, platform, and prize in a customizable world!
            </Typography>
          </Box>
          <Box mt={2} mb={5}>
            <Typography className={classes.regularTypography}>
              ...
              own creation, collecting prizes and scoring points! Draw a
              character who matches all over, or mix and match to create
              something new and unique. Dream big!
            </Typography>
          </Box>
