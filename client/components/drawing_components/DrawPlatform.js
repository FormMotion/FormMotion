...
const DrawPlatform = props => {
  ...
  const [desertMountainButtonColor, setDesertMountainButtonColor] =
    useState("#D3D3D3");
  const [mysteriousForestButtonColor, setMysteriousForestButtonColor] =
    useState("#D3D3D3");
  const [snowCoveredMountainsButtonColor, setsnowCoveredMountainsButtonColor] =
    useState("#D3D3D3");
        ...
        <Grid>
          ...
          >
            ...
            <Box mt={12}>
              ...
              <Button
                style={{
                  backgroundColor: desertMountainButtonColor,
                  margin: 10,
                }}
                variant="contained"
              ...
              <Button
                style={{
                  backgroundColor: mysteriousForestButtonColor,
                  margin: 10,
                }}
                variant="contained"
              ...
              <Button
                style={{
                  backgroundColor: snowCoveredMountainsButtonColor,
                  margin: 10,
                }}
                variant="contained"
