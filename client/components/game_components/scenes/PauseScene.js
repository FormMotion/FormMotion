...
export default class PauseScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.spaceBar = this.input.keyboard.addKey(
      ...
      //  Toggle Music Off On  Button
            ...
            console.log("pause scene this.scene:", this.scene)
            this.events.events.on('launch', (data) => {
  ...
  update() {
    ...
    if (spaceBarPressed) {
      console.log('SpaceBar was pressed - inside MainScene', this.soundPaused, this.musicPaused);
      this.scene.resume('MainScene', {
